...
internal class SalizerTest {
    ...
    fun leadDataClassFromJsonForJackson() {
        ...
        val uut = Salizer().dataClassFromJsonForJackson(leadAsJson, "com.github.sanandroid.jlsforce.dataclassdsl")
    ...
    fun allFieldsDataClassFromJsonForJackson() {
        ...
        val uut = Salizer().dataClassFromJsonForJackson(allFieldsAsJson, "com.github.sanandroid.jlsforce.dataclassdsl")
            .replace("\\p{Zs}+".toRegex(), "")
        val leadAsDataclass =
